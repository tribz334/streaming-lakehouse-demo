...
box(220, 405, 660, 65, "ADS 应用层", ("留存分析  |  归因分析  |  反作弊",), gray=True)
...
box(220, 735, 660, 70, "ODS 原始层", ("ods_log_inc",), gray=True)
...
pbox(220,405,660,65,"ADS 应用层",("留存分析 | 归因分析 | 反作弊",),True)
...
pbox(220,735,660,70,"ODS 原始层",("ods_log_inc",),True)
