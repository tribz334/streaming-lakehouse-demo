...
DATASETS = {
    ...
    "v_dwm_ad_event_wide": {
        ...
        "columns": [
            ("event_id", "VARCHAR", False, True, True),
            ("event_type", "VARCHAR", False, True, True),
            ("event_time", "DATETIME", True, True, True),
            ("event_date", "VARCHAR", False, True, True),
            ("advertiser_id", "VARCHAR", False, True, True),
            ("advertiser_name", "VARCHAR", False, True, True),
            ("industry_code", "VARCHAR", False, True, True),
            ("campaign_id", "VARCHAR", False, True, True),
            ("campaign_name", "VARCHAR", False, True, True),
            ("marketing_goal", "VARCHAR", False, True, True),
            ("creative_id", "VARCHAR", False, True, True),
            ("creative_type", "VARCHAR", False, True, True),
            ("unit_id", "VARCHAR", False, True, True),
            ("slot_id", "VARCHAR", False, True, True),
            ("media_id", "VARCHAR", False, True, True),
            ("slot_type", "VARCHAR", False, True, True),
            ("user_id", "VARCHAR", False, True, True),
            ("city_code", "VARCHAR", False, True, True),
            ("device_platform", "VARCHAR", False, True, True),
            ("impression_flag", "BIGINT", False, False, False),
            ("click_flag", "BIGINT", False, False, False),
            ("conversion_flag", "BIGINT", False, False, False),
            ("billing_type", "VARCHAR", False, True, True),
            ("actual_cost", "DECIMAL", False, False, False),
            ("conversion_value", "DECIMAL", False, False, False),
            ("order_id", "VARCHAR", False, True, True),
            ("gmv", "DECIMAL", False, False, False),
            ("attributed_date", "VARCHAR", False, True, True),
        ],
        "metrics": [
            ("count", "COUNT(*)"),
            ("total_cost", "SUM(actual_cost)"),
            ("total_gmv", "SUM(gmv)"),
            ("impressions", "SUM(impression_flag)"),
            ("clicks", "SUM(click_flag)"),
            ("conversions", "SUM(conversion_flag)"),
            ("roi", "SUM(gmv) / NULLIF(SUM(actual_cost), 0)"),
        ],
    },
