...
CREATE TABLE IF NOT EXISTS ods_dirty_log (
  raw_data STRING,error_reason STRING,error_time BIGINT,dt STRING
) PARTITIONED BY(dt) WITH ('bucket.num'='2','table.log.ttl'='3min');
...
CREATE TABLE IF NOT EXISTS dim_creative_df (
  creative_id BIGINT,creative_name STRING,unit_id BIGINT,unit_name STRING,
  campaign_id BIGINT,advertiser_id BIGINT,ad_type INT,placement_type INT,is_closed TINYINT,
  ...
  creative_video_id BIGINT,monitoring_url STRING,status INT,created_at STRING,updated_at STRING,dt STRING,
...
CREATE TABLE IF NOT EXISTS dwd_order_acc (
  ...
  receiver_phone STRING,shipping_address STRING,tracking_number STRING,order_status INT,
  create_time STRING,cancel_time STRING,pay_time STRING,confirm_time STRING,refund_time STRING,
  updated_at STRING,dt STRING,`hour` STRING,
  PRIMARY KEY(order_id) NOT ENFORCED
) WITH ('bucket.num'='2','table.datalake.enabled'='true','table.datalake.freshness'='30s');
-- Realtime DWS is created in StarRocks by starrocks/init_starrocks.sql.
...
CREATE TABLE IF NOT EXISTS dm_ad_advertiser_df (
  dt STRING,advertiser_id BIGINT,advertiser_name STRING,
...
CREATE TABLE IF NOT EXISTS dm_ad_campaign_df (
  dt STRING,campaign_id BIGINT,campaign_name STRING,
  delivery_count_1d BIGINT,
  delivery_count_7d BIGINT,
  delivery_count_30d BIGINT,
...
CREATE TABLE IF NOT EXISTS dm_ad_unit_df (
  dt STRING,unit_id BIGINT,unit_name STRING,placement_type INT,ad_type INT,
  delivery_count_1d BIGINT,
  delivery_count_7d BIGINT,
  delivery_count_30d BIGINT,
...
CREATE TABLE IF NOT EXISTS dm_ad_creative_df (
  dt STRING,creative_id BIGINT,creative_name STRING,
  delivery_count_1d BIGINT,
  delivery_count_7d BIGINT,
  delivery_count_30d BIGINT,
